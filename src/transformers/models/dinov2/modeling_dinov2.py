...
class Dinov2SdpaSelfAttention(Dinov2SelfAttention):
    ...
    def forward(
        ...
        if output_attentions or head_mask is not None:
            logger.warning_once(
                "`Dinov2SdpaAttention` is used but `torch.nn.functional.scaled_dot_product_attention` does not support "
...
__all__ = ["Dinov2ForImageClassification", "Dinov2ForMaskedImageModeling", "Dinov2Model", "Dinov2PreTrainedModel"]
